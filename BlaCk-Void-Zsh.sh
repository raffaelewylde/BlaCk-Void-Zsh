...
zshenv=$BVZSH/.zshenv
zlogin=$BVZSH/.zlogin
zprofile=$BVZSH/.zprofile
profile=$BVZSH/.profile
...
latest_update_date() {
	BVZSH_PLUGIN_RECEIPT_F=${BVZSH_PLUGIN_RECEIPT_F:-$BVZSH/.zsh_plugin_lastupdate}
	BVZSH_SYSTEM_RECEIPT_F=${BVZSH_SYSTEM_RECEIPT_F:-$BVZSH/.zsh_system_lastupdate}
